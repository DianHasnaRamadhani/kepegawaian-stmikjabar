                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="prosesedit.php" enctype="multipart/form-data" method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" readonly="" required="" placeholder="Nomor Induk Pegawai (NIP)" name="nip" value="<?php echo $d['nip'];?>">
                    </div>
                    <div class="form-group">
                      <label >Nama Lengkap</label>
                      <input type="text" class="form-control" required="" placeholder="Nama Lengkap" name="nama" value="<?php echo $d['nama'];?>">
                    </div>
                    <div class="form-group">
                      <label >Tempat Tanggal Lahir</label>
                      <input type="text" class="form-control" required="" placeholder="Tempat Tanggal Lahir" name="ttl" value="<?php echo $d['ttl'];?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label >Alamat</label>
                      <input type="text" class="form-control" required="" placeholder="Alamat" name="alamat" value="<?php echo $d['alamat'];?>">
                    </div>
                    <div class="form-group">
                      <label >Agama</label>
                      <input type="text" class="form-control" required="" placeholder="Agama" name="agama" value="<?php echo $d['agama'];?>">
                    </div>
                    <div class="form-group">
                      <label >Pendidikan Terakhir</label>
                      <input type="text" class="form-control" required="" placeholder="Pendidikan Terakhir" name="pend_terakhir" value="<?php echo $d['pend_terakhir'];?>"> 
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required="" placeholder="No. Telepon" name="no_telepon" value="<?php echo $d['no_telepon'];?>">
                    </div>
                    <div class="form-group">
                      <label >Password</label>
                      <input type="text" class="form-control" required="" placeholder="Password" name="password" value="<?php echo $d['password'];?>">
                    </div>
                    <div class="form-group">
                      <label>Foto </label>
                      <?php 
                        if ($d['foto']!=''){
                          echo "<img src=\"../forms/images/$d[foto]\" height=150 />";  
                        }
                        else{
